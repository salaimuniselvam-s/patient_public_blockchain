    ...
    <div className=" flex justify-center h-96">
      <div className="mt-24 w-3/5 rounded-md  bg-slate-400 border  border-slate-500 h-full">
        ...
        <input
          ref={userRef}
          type="text"
          className="w-4/5 rounded-md flex  px-3  ml-24 mt-3 py-2"
          value={user}
        ...
        <input
          ...
          ref={passwordRef}
          type="password"
          className="w-4/5 mt-3 px-3 py-2 rounded-md flex  ml-24"
        ...
        <button
          onClick={login}
          className="ml-24 border   px-5 rounded-md bg-blue-600 border-blue-600"
        >
          Login
        </button>
      </div>
